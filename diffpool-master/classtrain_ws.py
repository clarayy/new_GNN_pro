...
def benchmark_task_val(args, writer=None, feat='node-label'):
    ...
    for i in range(10):
        ...
        train_c9, val_dataset, val_dataset_1, max_num_nodes, input_dim, assign_input_dim = cross_val.prepare_val_data_c10(graphs, args, i, max_nodes=args.max_nodes)
        if args.method == 'soft-assign':
            print("i=", i)
            print('Method: soft-assign')
            model = encoders.SoftPoolingGcnEncoder(
    ...
    eva_result, eva_labels, eva_realpreds, eva_jordan_center, eva_unbet, eva_discen, eva_dynage = \
        evaluate_class_pro(val_dataset_1, model, m_c0, m_c1, m_c2, m_c3, m_c4, m_c5, m_c6, m_c7, m_c8, m_c9, args)
...
def evaluate_class_pro(dataset, model, model_c0, model_c1,model_c2,model_c3,model_c4,model_c5,
                       model_c6, model_c7, model_c8, model_c9, args, name='Validation', max_num_examples=None):
    ...
    class_reverse = [class0_reverse, class1_reverse, class2_reverse, class3_reverse, class4_reverse, class5_reverse,
                     class6_reverse, class7_reverse, class8_reverse, class9_reverse]  #dict的key不支持[]或{},他们是不可哈希的
